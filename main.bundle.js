...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,WAAW;IACX,YAAY;IACZ,SAAS;IACT,yBAAyB;AAC7B;;AAEA;IACI,UAAU;IACV,WAAW;IACX,wBAAwB;IACxB,aAAa;IACb,qCAAqC;IACrC,kCAAkC;IAClC,aAAa;IACb,SAAS;AACb;;;AAGA;IACI,mBAAmB;IACnB,UAAU;IACV,iBAAiB;IACjB,gBAAgB;EAClB","sourcesContent":["html, body{\n    width: 100%;\n    height: 100%;\n    margin: 0;\n    background-color: #e76f51;\n}\n\nbody{\n    width: 95%;\n    height: 90%;\n    background-color:#264653;\n    display: grid;\n    grid-template-columns: repeat(8, 1fr);\n    grid-template-rows: repeat(6, 1fr); \n    padding: 30px;\n    gap: 30px;\n}\n\n\nbody>div{\n    border-radius: 20px;\n    color: red; \n    font-size: medium;\n    font-weight: 700;\n  }\n"],"sourceRoot":""}]);
// Exports
